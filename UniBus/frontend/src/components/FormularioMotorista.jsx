...
function FormularioMotorista({ motorista, setMotorista, salvarMotorista }) {
    return (
        <div className="card">
            <h2 className="titulo-card">Cadastrar motorista 🚍</h2>
            ...
            <input
                ...
                onChange={e => setMotorista({ ...motorista, senha: e.target.value })}
            />
